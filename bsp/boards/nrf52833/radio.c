...
#define MAX_PACKET_SIZE           (512)       ///< maximal size of radio packet (one more byte at the beginning needed to store the length)
...
#define NUMBEROF8US         12  // in unit of 8 us
...
#define TSAMPLESPACING      3  // 1:4us 2:2us 3: 1us 4:500ns 5:250ns 6:125ns
